                      ...
                      if (record && record.flowData) {
                          ...
                          for (var i = 0; i < record.flowData.length; i++) {
                              var d = record.flowData[i],
                                  ...
                                  internet_bytes = d.internet_total_flow || 0,
                                  intranet_bytes = d.intranet_total_flow || 0;
                              chartData.push({ time: datetime, value: record.type == 0 ? intranet_bytes : internet_bytes });
                          }
