...
require.config({
    ...
    paths: {
        ...
        'jquery-scrollTo': '../vendor/jquery/jquery.scrollTo-1.4.3.1',
        'jquery-easypiechart': '../vendor/jquery/jquery.easypiechart.min',
        'jquery-viewport': '../vendor/jquery/jquery.viewport.mini',
        'jquery-autocomplete': '../vendor/jquery/jquery.autocomplete.min',
